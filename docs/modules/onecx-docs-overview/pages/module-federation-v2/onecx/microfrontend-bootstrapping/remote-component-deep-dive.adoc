...
:bootstrapRemoteComponent_url: xref:module-federation-v2/onecx/angular-webcomponents.adoc#bootstrap-remote-component
...
[cols="1,1"]
|===
| xref:module-federation-v2/onecx/microfrontend-bootstrapping/remote-component-bootstrapping.adoc[← Previous: Remote Component Bootstrapping]
