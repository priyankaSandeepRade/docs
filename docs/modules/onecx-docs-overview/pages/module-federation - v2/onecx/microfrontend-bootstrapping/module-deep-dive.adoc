:createAppEntrypoint_url: xref:../angular-webcomponents.adoc#create-app-entrypoint
:events_topic_url: xref:documentation:onecx-portal-ui-libs:libraries/integration-interface.adoc#events-topic
:initializeRouter_url: xref:../angular-webcomponents.adoc#initialize-router
:startsWith_url: xref:../angular-webcomponents.adoc#starts-with
...
[cols="1,1"]
|===
| xref:module-bootstrapping.adoc[← Previous: Module Bootstrapping and Configuration]
